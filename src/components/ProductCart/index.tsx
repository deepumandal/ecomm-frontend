...
interface componentInterface {
  product: productCardI & cartDataInterface;
}

const ProductCart: React.FC<componentInterface> = ({ product }) => {
  const {
    name,
    description,
    category,
      ...
      <Card>
        ...
        >
          ...
          <CardContent sx={{ width: "100%" }}>
            ...
            <ProductCartCalculation price={price} productCount={productCount} />
          </CardContent>
        </Stack>
      </Card>
    </Grid>
